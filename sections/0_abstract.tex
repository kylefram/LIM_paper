\begin{abstract}\newline
Spectral sensitivity functions of cameras with {\color{red} a fixed set of} color filters often result in color {\color{red} measurements} that do not match those {\color{red} captured} by the human eye. 
...
We also generalize our framework for other color matching functions beyond the CIE 1931 XYZ {\color{red} CMFs}.
\end{abstract}