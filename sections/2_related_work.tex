...
We define our camera's response for color channel $c\in \{R,G,B\}$ as the dot product between the corresponding row of $\boldsymbol{M}$ (defined $M_c$) and our selected filters' transmission functions $f_k(\lambda)$.
...
Next, we evaluate the performance of our procedure in context of our loss function as well as $\Delta E_{2000}$, for the CIE 1931 and CIE 2015 XYZ standard observers. 
