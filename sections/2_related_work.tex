...
Multispectral image capture requiring high shutter speeds my often be prohibitively expensive.
...
Lapray et al.\cite{lapray2014multispectral} compares filter wheels to other modern multispecral imaging implementations. 
