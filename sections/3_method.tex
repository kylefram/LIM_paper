...
The aim of our method is to capture multiple images through different colour filters and then combine them to match the colours of an image of  ascene captured with respect to specified CIE XYZ Color matching functions. For our filters we will choose of filters drawn from the color Rosco MyColor Tool \cite{rosco_mycolor} or from a Rosco Supergel filters that we measure in our lab. All filters are represented in the domain [400,750] nm and are normalized to have a max transmittance of 100\%
...
\begin{equation}
    L_c(t(\lambda),\frac{d \rho_c}{d\lambda})
    \label{eq:3}
\end{equation}
